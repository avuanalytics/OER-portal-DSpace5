    ...
    <xsl:template match="dim:dim" mode="itemSummaryList-DIM-metadata">
        ...
        <div class="artifact-description">
            ...
            <xsl:if test="dim:field[@element = 'description' and @qualifier='abstract']">
                <xsl:variable name="abstract" select="dim:field[@element = 'description' and @qualifier='abstract']"/>
                <div class="artifact-abstract">
                    ...
                    <xsl:value-of select="util:shortenString($abstracttext, 220, 10)"/>
                </div>
            </xsl:if>
        </div>
    </xsl:template>
                    ...
                    <xsl:otherwise>
                        <img alt="xmlui.mirage2.item-list.thumbnail" i18n:attr="alt">
                            <xsl:attribute name="data-src">
                                <xsl:text>holder.js/100%x180/text:No Thumbnail</xsl:text>
                            </xsl:attribute>
                        </img>
                    </xsl:otherwise>
                </xsl:choose>
