...
<xsl:stylesheet
                        ...
                        <xsl:when test="dri:list[@n=(concat($handle, ':dc.description.abstract'))]/dri:item/dri:hi">
                            <div class="abstract">
                                <xsl:for-each select="dri:list[@n=(concat($handle, ':dc.description.abstract'))]/dri:item">
                                    <xsl:call-template name="remove-html-node">
                        ...
                        <xsl:when test="dri:list[@n=(concat($handle, ':dc.description.abstract'))]/dri:item">
                            <div class="abstract">
                                <xsl:variable name="htmlbody">
                                    <xsl:for-each select="dri:list[@n=(concat($handle, ':dc.description.abstract'))]/dri:item//text()">
                                        <xsl:value-of select="."/>
                                    </xsl:for-each>
                                </xsl:variable>
                                <xsl:variable name="strippedabstract">
                                 <xsl:call-template name="remove-html">
                                     <xsl:with-param name="text" select="$htmlbody"/>
                                 </xsl:call-template>
                                </xsl:variable>
                                <xsl:value-of select="util:shortenString($strippedabstract, 220, 10)"/>
                            </div>
                        </xsl:when>
                    </xsl:choose>
                </div>
    ...
    <xsl:template name="remove-html-node">
        <xsl:param name="n"/>
