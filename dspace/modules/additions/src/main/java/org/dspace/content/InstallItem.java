...
public class InstallItem
{
    ...
    public static Item installItem(Context c, InProgressSubmission is,
        ...
        return installItem(c, is, suppliedHandle, false);
    }
     ...
     *            the existing Handle to give to the installed item
     * @param isMigration
     *            Indicate if this item comes from another DSpace instance
     * @return the fully archived Item
     */
    public static Item installItem(Context c, InProgressSubmission is,
            String suppliedHandle, boolean isMigration) throws SQLException,
            IOException, AuthorizeException
    {
